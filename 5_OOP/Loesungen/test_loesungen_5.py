...
def mensch():
    yield l_aufgabe_1.Mensch("Luca", 17, 1.82, 75, "männlich")


@pytest.fixture(scope="function")
def klasse():
    yield l_aufgabe_2.Klasse("10A")


@pytest.fixture(scope="function")
def schueler_a():
    yield l_aufgabe_2.Schueler("Max Mustermann")


@pytest.fixture(scope="function")
def schueler_b():
    yield l_aufgabe_2.Schueler("Erika Mustermann")


# Test ob die Dateien existieren
def test_aufgabe_1_exists():  # Funktionsfähigkeit durch Debug hergestellt.
    assert os.path.exists("5_OOP/Loesungen/l_aufgabe_1.py"), \
        "File does not exist"


def test_aufgabe_2_exists():  # Funktionsfähigkeit durch Debug hergestellt.
    assert os.path.exists("5_OOP/Loesungen/l_aufgabe_2.py"), \
        "File does not exist"


def test_aufgabe_3_exists():  # Funktionsfähigkeit durch Debug hergestellt.
    assert os.path.exists("5_OOP/Loesungen/l_aufgabe_3.py"), \
        "File does not exist"
...
def test_schueler_note_erfahren():
    schueler = l_aufgabe_2.Schueler("Max Mustermann",
                                    mathenote=4.5,
                                    deutschnote=3.7)
...
def test_schaf_bewegen():
    pos1 = l_aufgabe_3.Position(1, 2, 3)
    pos2 = l_aufgabe_3.Position(4, 5, 6)
    schaf = l_aufgabe_3.Schaf(pos1, "gruen")
...
def test_kuh_position_attribute():
    ...
    assert isinstance(
        kuh.Position, l_aufgabe_3.Position
    ), "Position attribute is not of type Position"
